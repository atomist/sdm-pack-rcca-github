...
export type IngestOrgsParameters = { id: string, providerId: string, apiUrl: string };

export const IngestOrgs: CommandHandlerRegistration<IngestOrgsParameters> = {
    name: "IngestOrgs",
    description: "Ingest organizations and repository into the Graph",
    tags: ["github"],
    parameters: {
